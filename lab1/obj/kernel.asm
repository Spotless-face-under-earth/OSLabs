...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005fc:	9f078793          	addi	a5,a5,-1552 # 80200fe8 <etext+0x5c0>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200658:	9c8a8a93          	addi	s5,s5,-1592 # 8020101c <etext+0x5f4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200660:	b9cb8b93          	addi	s7,s7,-1124 # 802011f8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008b6:	76660613          	addi	a2,a2,1894 # 80201018 <etext+0x5f0>
    ...
    802008c8:	74460613          	addi	a2,a2,1860 # 80201008 <etext+0x5e0>
    ...
    802008da:	72a40413          	addi	s0,s0,1834 # 80201000 <etext+0x5d8>
    ...
    80200964:	6a040413          	addi	s0,s0,1696 # 80201000 <etext+0x5d8>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    8020097a:	68ba0a13          	addi	s4,s4,1675 # 80201001 <etext+0x5d9>
